...
student_01 = Student('Иван', 'Иванов', 'Неизвестный')
student_01.courses_in_progress += ['Python', 'VC']
student_01.finished_courses += ['C+']

student_02 = Student('Глеб', 'Ростошев', 'Неизвестный')
student_02.courses_in_progress += ['Python', 'C+']
student_02.finished_courses += ['Java', 'VC']

reviewer_01 = Reviewer('Олег', 'Кусков')
reviewer_01.courses_attached += ['Python', 'C+', 'Java']

reviewer_02 = Reviewer('Владислав', 'Суршов')
reviewer_02.courses_attached += ['Python', 'VC']

lecturer_01 = Lecturer('Елена', 'Томбова')
lecturer_02 = Lecturer('Андрей', 'Сушков')
...
print('Иван Иванов < Глеб Ростошев ', student_01 < student_02)
print('Елена Тамбова > Андрей Сушков ', lecturer_01 > lecturer_02)
print('Иван Иванов < Елена Тамбова ', student_01 < lecturer_01)
print()
