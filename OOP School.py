...
# Данный фрагмент написан на языке Python. Он описывает создание списка студентов, добавление курсов в их список курсов и добавление оценок в их список оценок.
